...
const Map = ({ updateAddress }: MapProps) => {
  ...
  return (
    <div style={{ width: "100%", height: "100%" }}>
      {isLoaded && (
        <>
          <div className={`background-light800_darkgradient mb-4 flex size-full min-h-[56px] grow items-center gap-4 rounded-[10px] px-4`}>
            <Image src="assets/icons/search.svg" alt="search icon" width={24} height={24} className="cursor-pointer" />
            <Input id="search-box" type="text" placeholder="Search for your location" className="text-dark400_light700 paragraph-regular no-focus placeholder text-dark400_light700 border-none bg-transparent shadow-none outline-none" />
          </div>
